<ul class="nav nav-tabs nav-justified mb-3">
    ...
    <li class="nav-item"><a href="{{ route('users.followings', ['id' => $user_id]) }}" class="nav-link {{ Request::is('users/*/followings') ? 'active' : '' }}">Followings <span class="badge badge-secondary">{{ $count_followings }}</span></a></li>
